  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#25D366] hover:bg-[#1ebe5d] active:bg-[#17a852] transition-colors duration-150 touch-manipulation"
      >
        ...
        <span className="text-[10px] uppercase tracking-[0.15em] font-sans font-semibold text-white">
          WhatsApp
        </span>
      </button>
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-stone-200 dark:border-stone-700 hover:border-stone-400 dark:hover:border-stone-500 transition-colors duration-150 touch-manipulation"
      >
        {copied ? (
        ...
        <span className={`text-[10px] uppercase tracking-[0.15em] font-sans font-medium transition-colors duration-150 ${copied ? "text-green-500" : "text-stone-400 dark:text-stone-500"}`}>
          {copied ? "Copied" : "Copy"}
        </span>
      </button>
    </div>
