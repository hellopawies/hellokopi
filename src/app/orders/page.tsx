  ...
  return (
    <div className="flex items-center gap-1">
      <button
        ...
        className="p-1.5 rounded-lg text-stone-400 dark:text-stone-500 hover:text-stone-700 dark:hover:text-stone-200 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors duration-150 touch-manipulation"
      >
      ...
      <button
        ...
        className="p-1.5 rounded-lg transition-colors duration-150 touch-manipulation text-stone-400 dark:text-stone-500 hover:text-stone-700 dark:hover:text-stone-200 hover:bg-stone-100 dark:hover:bg-stone-800"
      >
        {copied ? (
