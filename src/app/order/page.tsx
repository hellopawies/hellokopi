...
function OrderContent() {
  ...
  return (
    <main className="min-h-[100dvh] bg-[#FAFAF8] flex flex-col items-center justify-center px-5 sm:px-8">
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-stone-200 to-transparent" />
      <div className="w-full max-w-sm sm:max-w-md flex flex-col items-center text-center gap-5 sm:gap-6">
        ...
        <p className="font-serif text-base sm:text-lg font-light italic text-stone-400">
