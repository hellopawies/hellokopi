// v3.5.11 was an internal polish pass (mobile bento width, hero affordance,
// skeleton dwell timing, page-in tightening, /orders empty state, reduced-
// motion). Not surfaced to users — the version number is intentionally
// retained so the next user-visible release ships as v3.5.12.
